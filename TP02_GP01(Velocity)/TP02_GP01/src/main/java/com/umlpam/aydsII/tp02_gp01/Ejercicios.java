...
public class Ejercicios {
    ...
    */
    ...
    resta de ambos.
    */
    public String operaciones(int a, int b, String op){   
        Integer rta = 5555;
        if(op.equals("+")){
            rta = a + b;
        }else if(op.equals("-")){
        ...
        return rta.toString();
        //return "La suma de los numeros es " + (a + b) + " y la resta es " + (a-b);
    }
    ...
    */
    public String equiposFutbol(String teamID) throws Exception{
        final String apiKey = "d75abd6f1ff60020d80852164b2bfb33bfd726daa7b86c4dd9c83201b46a91c8";
        HttpClient client = HttpClients.createDefault();
        HttpGet request = new HttpGet("https://apiv2.allsportsapi.com/football/?&met=Teams&teamName=" + teamID + "&APIkey=" +  apiKey);
    ...
    */
    ...
    public String getDolarOficial() throws Exception {       
        ...
        HttpGet httpGet = new HttpGet("https://dolarapi.com/v1/dolares");
